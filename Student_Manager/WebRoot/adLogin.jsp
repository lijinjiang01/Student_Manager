    ...
    <div class="login-body">
        <section>
            ...
            <ul class="nav nav-tabs">
                ...
                <li  class="active"><a href="adLogin.jsp">管理员登录</a></li>
                </ul>
            </div>
            <form id="login" action="adLogin" method="post" class="form-horizontal" role="form">
                <div class="form-group">
                    <label class="col-sm-2 col-xs-2 col-sm-offset-2 control-label">管理员</label>
                    <div class="col-sm-4 col-xs-10">
                        <input type="text" name="a.id" class="form-control" name="id" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 col-sm-offset-2 col-xs-2 control-label">密&emsp;码</label>
                    <div class="col-sm-4 col-xs-10">
                        <input type="password" name="a.password" class="form-control" name="password" />
                    </div>
                </div>
                <div class="form-group">
