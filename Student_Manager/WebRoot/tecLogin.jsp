    ...
    <div class="login-body">
        <section>
            ...
            <ul class="nav nav-tabs">
                <li><a href="stuLogin.jsp">学生登录</a></li>
                <li class="active"><a href="tecLogin.jsp">教师登录</a></li>
                <li><a href="adLogin.jsp">管理员登录</a></li>
                </ul>
            </div>
            <form id="login" action="tecLogin" method="post" class="form-horizontal" role="form">
                <div class="form-group">
                    <label class="col-sm-2 col-xs-2 col-sm-offset-2 control-label">教师号</label>
                    <div class="col-sm-4 col-xs-10">
                        <input type="text" name="t.tno" class="form-control" name="id" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 col-sm-offset-2 col-xs-2 control-label">密&emsp;码</label>
                    <div class="col-sm-4 col-xs-10">
                        <input type="password" name="t.password" class="form-control" name="password" />
                    </div>
                </div>
                <div class="form-group">
